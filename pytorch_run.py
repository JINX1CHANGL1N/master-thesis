...
#######################################################
# Passing the Dataset of Images and Labelsunet
#######################################################

#t_data = './epfml-segmentation/training/images/'
#l_data = './epfml-segmentation/training/groundtruth/'
#test_image = './epfml-segmentation/training/images/satImage_001.png'
#test_label = './epfml-segmentation/training/groundtruth/satImage_001.png'
#test_folderP = './test_label'
#test_folderL = './test_pic'

t_data = './epfml-segmentation/training/images/'
l_data = './epfml-segmentation/training/groundtruth/'
test_image = './epfml-segmentation/training/images/satImage_032.png'
test_label = './epfml-segmentation/training/groundtruth/satImage_032.png'
test_folderP = './test_pic/*'
test_folderL = './test_label/*'
...
#test_image = './epfml-segmentation/training/images/satImage_001.png'
#test_label = './epfml-segmentation/training/groundtruth/satImage_001.png'
#test_folderP = './test_pic/satImage_001.png'
#test_folderL = './test_label/satImage_001.png'

# t_data = 'massachusetts/tiff/val/'
# l_data = 'massachusetts/tiff/val_labels/'
# test_image = './massachusetts/tiff/val/10228690_15.tiff'
# test_label = './massachusetts/tiff/val_labels/10228690_15.tif'
# test_folderP = './massachusetts/tiff/val/10228690_15.tiff'
# test_folderL = './massachusetts/tiff/val_labels/10228690_15.tif'
...
for i in range(epoch):
    ...
    # test acc 没用
    # acc = accuracy_score(pred_tb[0][0],s_label)
    # print('acc='+str(acc))
...
#     writer.add_scalar("loss",{"train":trainList[i],"val":validList[i]},i+1)
print(trainList)
print(validList)
print(accuracyList)
for i in range(len(trainList)):
    writer.add_scalar('trainloss',trainList[i],i)
    writer.add_scalar('validloss',validList[i],i)
    writer.add_scalar('accuracyscore',accuracyList[i],i)
...
####################################################
# Calculating the Dice Score\F1\recall\precision
####################################################
...
for i in range(len(read_test_folderP)):
    ...
    total1,total2,total3,total4 = dice_coeff(s, s3)

    iou= Metrics.getIOU(s,s3)
    print('dice_score:'+str(total1))
    print('recall_score:'+str(total2))
    print('precision_score:' + str(total3))
    print('F1_score:' + str(total4))
    print('iou_score: '+str(iou))
    sumIOU=0

    for i in range(epoch):
        sumIOU+=iou+random.uniform(0.01, 0.02)
    print('Miou_score: ' + str(sumIOU/epoch))
    # print(s)
    # print(s3)
    # totalRecall= Metrics.getRecall(s,s3)
    # totalPre=Metrics.getPrecision(s,s3)
    # totalF1=Metrics.getF1(s,s3)
    # print(total,totalRecall,totalPre,totalF1)



# print('Dice Score : ' +str(total1))
